defmodule FruitPickerWeb.Admin.TreeView do
  ...
  def tree_sprayed_options do
    [
      {"No", "No"},
      {"Yes, with a common pesticide or insecticide", "Yes, with a common pesticide or insecticide"},
  ...
  def deactivate_options do
    [
      ...
      {"I am no longer interested in participating in this program", "I am no longer interested in participating in this program"}
    ]
  end
end
